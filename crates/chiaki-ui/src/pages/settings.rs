...
fn set_bool(s: &mut chiaki_settings::settings::Settings, id: &str, value: bool) {
    match id {
        ...
        "video-overlay-bitrate" => s.set_overlay_bitrate(value),
        "video-overlay-rtt" => s.set_overlay_rtt(value),
        "video-overlay-loss" => s.set_overlay_loss(value),
        "video-overlay-frametime" => s.set_overlay_frametime(value),
        "video-overlay-fps" => s.set_overlay_fps(value),
        "video-overlay-audio" => s.set_overlay_audio(value),
        "video-overlay-decoder" => s.set_overlay_decoder(value),
        "video-overlay-haptics" => s.set_overlay_haptics(value),
        "video-overlay-debug" => s.set_overlay_debug(value),
